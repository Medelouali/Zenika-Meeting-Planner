...
public class DomainsBuilder {
    ...
    public Map<Meeting, ArrayList<Room>> build(ArrayList<Meeting> meetings, ArrayList<Room> rooms){
        Map<Meeting, ArrayList<Room>> meetingToCandidateRooms= new HashMap<>();
        for(Meeting meeting : meetings){
            ArrayList<Room> verifiedRoomsList=new ArrayList<>();
